...
dropdown_menu = wait.until(EC.element_to_be_clickable((By.XPATH, 
"//div[@aria-labelledby='navbarDropdown1']/ul/li/a[@title='All Tractors']")))
dropdown_menu.click()
time.sleep(1)
...
#  div.filter-block-main-inner label:nth-child(0)
brands = driver.find_element(By.CSS_SELECTOR, 
'div.filter-block-list div.filter-block-main:nth-child(2)')

# brands = wait.until(EC.element_to_be_clickable((By.CSS_SELECTOR, 
# 'div.filter-block-list div.filter-block-main:nth-child(2)')))
for b in brands:
    print('brands-', b)
...
# driver.get('https://www.tractorjunction.com/tractors/?shortBy=&prices=&hps=&brands=57')
...
#         urllib.request.urlretrieve(str(src[i]), img_name+extension.format(i))
