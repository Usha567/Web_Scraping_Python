...
driver.get('https://www.tractorjunction.com/tractor-combine-harvesters/?shortBy=&harbrand=68&cutting=&power=')
...
for i in range(1,3):
    ...
    try:
        ...
        for tr in tr_list:
            ...
            if (text.capitalize()).strip() == 'Standard Fitments Features' or (text.capitalize()).strip() == 'Engine':
                ...
                for i in range(index+1, index+5):
                    try:
                        ...
                        engine_text_list.append(new_tr_text)
            ...
            if  (text).strip() == 'CUTTER BAR' or (text).strip() == 'CUTTER BAR MECHANISM': 
                index = tr_list.index(tr)
                print('index-',index,  tr.find_element(By.CSS_SELECTOR,  "td:nth-child(1)").text)
                for i in range(index+1, index+4):
                    try:
                        ...
                        new_tr_ans_text = tr_list[i].find_element(By.CSS_SELECTOR, "td:nth-child(2)").text
                        print('rangei-', i, new_tr_text) 
                        cutting_text_list.append(new_tr_text)
            ...
            if  (text).strip() == 'Reel Assembly' or (text).strip() == 'REEL': 
                index = tr_list.index(tr)
                print('index-',index,  tr.find_element(By.CSS_SELECTOR,  "td:nth-child(1)").text)
                for i in range(index+1, index+3):
                    try:
                        ...
                        new_tr_ans_text = tr_list[i].find_element(By.CSS_SELECTOR, "td:nth-child(2)").text
                        print('rangei-', i, new_tr_text)
                        reel_text_list.append(new_tr_text)
            ...
            if  (text).strip() == 'THRESHING EQUIPMENT' or  (text).strip() == 'THRESHING DRUM': 
                index = tr_list.index(tr)
                print('index-',index,  tr.find_element(By.CSS_SELECTOR,  "td:nth-child(1)").text)
                for i in range(index+1, index+9):
                    try:
                        ...
                        print('rangei-', i, new_tr_text)
                        if new_tr_text !='':
                            threshing_text_list.append(new_tr_text)
                        else:
                            threshing_text_list.append('')

                        if new_tr_ans_text !='':   
                            threshing_ans_list.append(new_tr_ans_text)
                        else:
            ...
            if  (text).strip() == 'Grain Tank': 
                ...
                for i in range(index+1, index+4):
                    try:
                        ...
                        print('rangei-', i, new_tr_text)
                        if new_tr_text !='':
                            graintank_text_list.append(new_tr_text)
                        else:
            ...
            if  (text).strip() == 'CAPACITY' or (text).strip() == 'Capacity (Ltr)': 
                index = tr_list.index(tr)
                print('index-',index,  tr.find_element(By.CSS_SELECTOR,  "td:nth-child(1)").text)
                for i in range(index+1, index+3):
                    try:
                        ...
                        print('rangei-', i, new_tr_text)
                        if new_tr_text !='':
                            capacity_text_list.append(new_tr_text)
                        else:
            ...
            if  (text.capitalize()).strip() == 'Clutch': 
                ...
                for i in range(index+1, index+2):
                    try:
                        ...
                        print('rangei-', i, new_tr_text)
                        if new_tr_text !='':
                            clutch_text_list.append(new_tr_text)
                        else:
            ...
            if  (text.capitalize()).strip() == 'Tyres': 
                index = tr_list.index(tr)
                print('index-',index,  tr.find_element(By.CSS_SELECTOR,  "td:nth-child(1)").text)
                for i in range(index+1, index+5):
                    try:
                        ...
                        print('rangei-', i, new_tr_text)
                        if new_tr_text !='':
                            tyre_text_list.append(new_tr_text)
                        else:
            ...
            if  (text).strip() == 'Overall Dimension' or (text).strip() == 'Dimensions' or (text).strip() == 'DIMENSIONS'  or (text).strip() == 'Overall Dimension (mm)': 
                index = tr_list.index(tr)
                print('index-',index,  tr.find_element(By.CSS_SELECTOR,  "td:nth-child(1)").text)
                for i in range(index+1, index+5):
                    try:
                        ...
                        if new_tr_text !='':
                            dimension_text_list.append(new_tr_text)
                        else:
        ...
        if 'Width (mm)' in threshing_text_list or 'Width' in threshing_text_list or 'Threshing Section Width' in threshing_text_list:
        ...
        if 'Outside dia (mm)' in threshing_text_list or 'Diameter' in threshing_text_list or 'Drum Diameter' in threshing_text_list:
        ...
        if 'Length (mm)' in dimension_text_list or 'Length' in dimension_text_list:
...
writer = pd.ExcelWriter('IndoForm_Harvester.xlsx', engine='xlsxwriter')
