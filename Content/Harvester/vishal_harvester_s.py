            ...
            for tr in tr_list:
                ...
                if (text.capitalize()).strip() == 'Engine':
                    ...
                    for i in range(index+1, index+5):
                        try:
                            new_tr_text = tr_list[i].find_element(By.CSS_SELECTOR, "td:nth-child(1)").text
                ...
                if  (text).strip() == 'Cutter Bar Assembly': 
                    index = tr_list.index(tr)
                    print('index-',index,  tr.find_element(By.CSS_SELECTOR,  "td:nth-child(1)").text)
                ...
                if  (text).strip() == 'Overall Dimension': 
                    index = tr_list.index(tr)
                    print('index-',index,  tr.find_element(By.CSS_SELECTOR,  "td:nth-child(1)").text)
                    for i in range(index+1, index+5):
                        try:
