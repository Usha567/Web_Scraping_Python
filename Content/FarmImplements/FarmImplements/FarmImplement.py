...
driver.get('https://www.tractorjunction.com/tractor-implements/?shortBy=&brands=&impType=5&impCat=56')
...
print('new_harvester--- ',new_harvester,  len(new_harvester))
brand_list=[]
model_list=[]
images_name=[]
image_list=[]
...
for i in range(1,4):
    ...
    for file in rem_bgfiles:
        ...
        with Image.open(dirname+file) as img:
            ...
            if((width > 450 and width!=650 and width!= 489 and width!=730 and width!=550 and width != 469 and width != 1400 and width != 600  and width != 500 and width != 601)  and (height>180 and height!=450 and height!=352 and height!=389 and height!=361 and height!=374 and height!=933 and height!=350 and height!=500 and height != 601)):
                print('if...')
    ...
    image_type_name.append('product')
    driver.back()
    time.sleep(2)
...
data_dict = {
    ...
    'Image_Type_Nmae':image_type_name
}
df=pd.DataFrame.from_dict(data_dict, orient="index")
df= df.transpose()

writer = pd.ExcelWriter('Implement.xlsx', engine='xlsxwriter')
