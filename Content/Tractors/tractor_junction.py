...
for i in range(1, 6):
    ...
    new_tractor = wait.until(EC.element_to_be_clickable((By.CSS_SELECTOR,"div#tractorMoreData div:nth-child("+str(i)+")>div.new-tractor-main>div.new-tractor-img>a>img")))
    new_tractor.click()
    time.sleep(2)
    ...
    # about=driver.find_element(By.CSS_SELECTOR, 'div.product_description_main>p').text
    ...
    # driver.execute_script('window.scrollTo(0, 500)')
    # close_modal= wait.until(EC.element_to_be_clickable((By.CSS_SELECTOR, 
    # "div.tj-product-list-popup span.list_close")))
    # close_modal.click()
    # time.sleep(1)


print('about_list--//-', about_list)
data_dict = {
    'Brand':brand_list,
    'Model':model_list,
...
writer = pd.ExcelWriter('Tractor_Infos.xlsx', engine='xlsxwriter')
