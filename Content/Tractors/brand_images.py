...
#     try:
        ...
        # image_list
brand_divs = driver.find_elements(By.CSS_SELECTOR, 'div#brandstabcontent div.tjcol.states-block')
...
# brand_list.append(brand)  
print('brand_list-///',brand_list)      
tractor_images = driver.find_elements(By.CSS_SELECTOR, "div#brandstabcontent div.tjcol.states-block div.brand-main>a>div.brands-main-inner-img>img")
src =[]

print('tractor_brnd_images-', len(tractor_images))
...
for i in range((len(src))):
    ...
    if(src[i] != ''):
        ...
        # urllib.request.urlretrieve(str(src[i]), "Brand_Images/"+img_name+'.png'.format(i))
...
writer = pd.ExcelWriter('Tractor_brand_Images.xlsx', engine='xlsxwriter')
