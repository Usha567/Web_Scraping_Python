    ...
    for i in range(680, 690):
        ...
        try:
            try:
                ...
                tractor=WebDriverWait(driver, 30).until(EC.presence_of_element_located((By.CSS_SELECTOR,"div#tractorMoreData div:nth-child("+str(i)+")>div.new-tractor-main>div.new-tractor-img>a>img")))
                print('located..///')
            ...
            try:
                ...
                while buttonText == 'Load More Tractors':
                    ...
                    if buttonText != 'Load More Tractors':
                        ...
                        load_more = WebDriverWait(driver, 2).until(EC.element_to_be_clickable((By.ID, "loadmorebtn")))
                        # time.sleep()
                        driver.execute_script("arguments[0].click();", load_more)
                        # load_more.click()
...
writer = pd.ExcelWriter('Tractor_brand_Infos.xlsx', engine='xlsxwriter')
