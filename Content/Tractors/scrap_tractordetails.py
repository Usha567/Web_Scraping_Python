        ...
        if buttonText != 'Load More Tractors':
            ...
            try:
                ...
                for i in range(46, 47):
                    ...
                    try:
                        # print('again click on load more..')
                        # load_more = wait.until(EC.element_to_be_clickable((By.ID, "loadmorebtn")))
                        # load_more.click()
                        # load_more.click()
                        # time.sleep(2)
                        ...
                        try:
                            ...
                            # modal_= WebDriverWait(driver, 15).until(EC.presence_of_element_located((By.CSS_SELECTOR,"div.modal-dialog div.modal-content>span.close")))
                            # modal_close= WebDriverWait(driver, 15).until(EC.element_to_be_clickable((By.CSS_SELECTOR,"div.modal-dialog div.modal-content>span.close")))
                            # modal_close.click()
...
writer = pd.ExcelWriter('Tractor_Infos1.xlsx', engine='xlsxwriter')
