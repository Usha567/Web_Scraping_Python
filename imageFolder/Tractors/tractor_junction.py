...
driver.get('https://www.tractorjunction.com/tractors/?shortBy=&prices=&hps=&brands=223')
...
for i in range((len(src))):
    ...
    if(src[i] != ''):
        ...
        urllib.request.urlretrieve(str(src[i]), "Hindustan/"+img_name+extension.format(i))
