...
driver.get('https://www.tractorjunction.com/tractor-combine-harvesters/?shortBy=&harbrand=59&cutting=&power=')
...
for i in range((len(src))):
    ...
    if(src[i] != ''):
        ...
        urllib.request.urlretrieve(str(src[i]), "John_Deere/"+img_name+extension.format(i))
